        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            >
              ...
              <Marker interactive={false} icon={happyMapIcon} position={[-8.1256899,-35.0278015]} /> 
{/*               
              { position.latitude !== 0 ? 
                <Marker interactive={false} icon={happyMapIcon} position={[position.latitude,position.longitude]} /> : null 
              } */}
